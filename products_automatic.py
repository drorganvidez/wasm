...
result = dm.use_operation_from_file("ValidProduct", "./tutorial-main/models/pizzas/pizzas.fide",configuration_file="./tutorial-main/models/pizzas_nonvalid.csvconf"  ) # This launch the operation and stores the result on the result variable
